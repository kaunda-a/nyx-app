...
export const proxiesApi = {
   ...
   * Update a proxy
   *
   * @param proxyId - The ID of the proxy to update
   * @param proxyData - The proxy data to update
   */
  update: async (proxyId: string, proxyData: ProxyUpdate): Promise<ProxyResponse> => {
    return api.put(`/api/proxies/${proxyId}`, proxyData);
  },
